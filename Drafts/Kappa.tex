...
tested) is that artificial borders, borders drawn by an exogenous
...
tests this more explicitly and find that states whose borders to a larger degree split ethnic
groups, are more often involved in international disputes, and that countries
whose boundaries group together ethnic groups with more different forms pre-colonial
