...
For the mechanism whereby the post-independence state increases its relative
state capacity by 

All pre-colonial states are not likely to 
...
Charles?], and while Ghana has suffered from many coups and dictators, there has
been little state-based violence.
...
\subsection{Symbols of sovereignty} \label{Symbols of sovereignty}
...
the autonomy of Puntland. % TODO: What was the source for this!?
...
\input{"../R/Output/summaryStats.tex"}
...
\input{"../R/Output/atlasmaps.tex"}
\input{"../R/Output/zinb.tex"}
