...
In any event where a pre-colonial state can be said to be conflict inducing 
...
likely to be have an out sized share of power in government. This can come about
through indirect colonial rule, which preferred to leave existing power
...
ask them point blank, but everyones definition of democracy does not conform to
