...
H2: Grid cells with higher state presence experience higher levels of civil conflict. 
...
%TODO: find the mean number of different pre-colonial states per country with
%Charles
...
conflict mediated by lower levels of support for humanist ideas or liberal
values.
...
Wishman \& Butcher (forthcoming), but has only been tested at a country level
...
H4.1: Grid cells with higher levels of state presence, in grid cells dominated by
a country that hosts more unique pre-colonial states experience higher levels of
civil conflict.

H4.1: Grid cells with higher levels of state presence, in grid cells dominated
by a country that hosts only one unique pre-colonial state experience lower
