...
overarching models that continue to inform not only the works presented in
...
bargained solution, these models focus on the situations in which bargaining
none the less breaks down, or the exception when conflict becomes a rational
choice (Section \ref{Bargaining}). It should be mentioned that these models are
by no means mutually exclusive, and throughout the thesis I draw on each of
...
Responding to the criticism of the opportunities model (covered below in Section
...
capacity/balance of power. \citet{Fearon1995} outlines three basic reasons
...
In relation to the previous comment, it would be good to build a bridge between
these sections, something like, drawing from these theoretical traditions, I
build a new theory of how historical states shape conflict and peace in the
modern world. The main argument of the thesis, and its main theoretical
